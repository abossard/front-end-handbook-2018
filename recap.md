...
* static typing is getting adopted more, [especially](http://www.npmtrends.com/flow-bin-vs-typescript) [Typescript](https://github.com/Microsoft/TypeScript), there's also [Flow](https://github.com/facebook/flow). For some people it's an [emotional](http://2ality.com/2018/03/javascript-typescript-reasonml.html#conclusion-the-javascript-ecosystem-is-stronger-than-ever) topic.
